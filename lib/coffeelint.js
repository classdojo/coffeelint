...
(function() {
  var ASTLinter, CoffeeScript, LexicalLinter, LineLinter, block_config, coffeelint, createError, defaults, extend, mergeDefaultConfig,
    __slice = [].slice,
  ...
  LineLinter = (function() {
    ...
    LineLinter.prototype.checkTrailingWhitespace = function() {
      if (coffeelint.Regexes.TRAILING_WHITESPACE.test(this.line)) {
    ...
    LineLinter.prototype.checkTrailingSemicolon = function() {
      ...
      hasSemicolon = coffeelint.Regexes.TRAILING_SEMICOLON.test(this.line);
  ...
  mergeDefaultConfig = function(userConfig) {
    var config, rule, ruleConfig, _ref;
    config = {};
    _ref = coffeelint.Rule;
    for (rule in _ref) {
      ruleConfig = _ref[rule];
