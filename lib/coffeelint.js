...
(function() {
  ...
  coffeelint.Regexes = {
    IDENTIFIER: /(^_id)|(^[a-zA-Z][a-zA-Z\d]*$)/,
  ...
  coffeelint.lint = function(source, userConfig) {
    var allErrors, astErrors, astLinter, cmd, config, difference, disabled, e, errors, i, initiallyDisabled, k, lexErrors, lexicalLinter, line, lineErrors, lineLinter, lines, nextLine, r, rules, s, tokensByLine, v, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4;
    if (userConfig == null) {
      userConfig = {};
    }
    lines = source.split("\n");
